...
function addPizzaToCard(elem) {
    ...
    $("#card_ul_id").append('<li class=\"cart-item\" id=\"' + choosePizzaitem.id + '_item\">' + choosePizzaitem.name + "<span class=\"cart-item-price\">" + choosePizzaitem.price.toFixed(2) + "</span><span class=\"cart-item-desc\"><a href=\"#\" id=\"" + choosePizzaitem.id + '\" class=\"cart-button\" onclick=\"removeFromCard(this)\">Usuń</a></span><span class=\"cart-item-price\"></li>');
